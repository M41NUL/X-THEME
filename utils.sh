...
err_msg()  { echo -e "  ${R}${B}[✘]${RST}  ${W}$1${RST}"; }
info_msg() { echo -e "  ${O}${B}[→]${RST}  ${W}$1${RST}"; }
warn_msg() { echo -e "  ${YE}${B}[!]${RST}  ${W}$1${RST}"; }
dim_msg()  { echo -e "  ${DIM}${W}$1${RST}"; }

separator()      { echo -e "  ${O}${DIM}$(printf '%0.s─' {1..54})${RST}"; }
separator_heavy(){ echo -e "  ${O}${B}$(printf '%0.s━' {1..54})${RST}"; }
